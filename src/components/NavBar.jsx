...
export default function NavBar(props) {
    ...
    return (
        <div className="nav-container">
            ...
            <span className="nav-span"><a href="https://www.linkedin.com/in/stephen-burnett" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon className="footer-logo fa-2x" icon={faGithub} /></a></span>
